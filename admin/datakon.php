            ...
            <div class="card-header">
                <h4>
                    ...
                    <?php if ($userRole == 'admin') : ?>
                        <a href="datakon-create.php" class="btn btn-primary float-end">Tambah Kontak Satuan</a>
                    <?php endif; ?>
                </h4>
            </div>
            <div class="card-body">
                                ...
                                foreach ($dataKontak as $Item) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($userRole == 'admin') : ?>
                                                <a href="datakon-edit.php?id=<?= $Item['id']; ?>" class="btn btn-success btn-sm mx-2">Edit</a>
                                                <a href="datakon-delete.php?id=<?= $Item['id']; ?>"
