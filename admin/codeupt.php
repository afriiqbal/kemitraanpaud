...
if(isset($_POST['saveKontakupt'])) 
{
    ...
    {
        $query = "INSERT INTO datakontakupt (prov, kabkot, name, kontak) 
        ...
        if($query_run)
        {
            ...
            header("Location: datakon-upt.php");
            exit(0);
        }
        else
        {
            $_SESSION['status'] = "Failed to Add Contact";
            header("Location: datakon-create-upt.php");
            exit(0);
        }
    }
    else
