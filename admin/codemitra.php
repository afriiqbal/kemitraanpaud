...
if(isset($_POST['saveKontakmitra'])) 
{
    ...
    {
        $query = "INSERT INTO datakontakmitra (prov, kabkot, name, kontak) 
        ...
        if($query_run)
        {
            ...
            header("Location: datakon-mitra.php");
            exit(0);
        }
        else
        {
            $_SESSION['status'] = "Failed to Add Contact";
            header("Location: datakon-create-mitra.php");
            exit(0);
        }
    }
    else
