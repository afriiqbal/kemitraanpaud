            ...
            <div class="card-header">
                <h4>
                    ...
                    <?php if ($userRole == 'admin') : ?>
                        <a href="datakon-create-mitra.php" class="btn btn-primary float-end">Tambah Kontak Mitra</a>
                    <?php endif; ?>
                </h4>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                        $dataKontakmitra = getAll('datakontakmitra');
                        if ($dataKontakmitra) {
                            if (mysqli_num_rows($dataKontakmitra) > 0) {
                                foreach ($dataKontakmitra as $Item) {
                                    ?>       
                                    <tr>
                                        <td><?= $Item['id']; ?></td>
                                        <td><?= $Item['prov']; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($userRole == 'admin') : ?>
                                                <a href="datakon-edit-mitra.php?id=<?= $Item['id']; ?>" class="btn btn-success btn-sm mx-2">Edit</a>
                                                <a href="datakon-delete-mitra.php?id=<?= $Item['id']; ?>"
