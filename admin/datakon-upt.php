            ...
            <div class="card-header">
                <h4>
                    ...
                    <?php if ($userRole == 'admin') : ?>
                        <a href="datakon-create-upt.php" class="btn btn-primary float-end">Tambah Kontak UPT</a>
                    <?php endif; ?>
                </h4>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                        $dataKontakupt = getAll('datakontakupt');
                        if ($dataKontakupt) {
                            if (mysqli_num_rows($dataKontakupt) > 0) {
                                foreach ($dataKontakupt as $Item) {
                                    ?>       
                                    <tr>
                                        <td><?= $Item['id']; ?></td>
                                        <td><?= $Item['prov']; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($userRole == 'admin') : ?>
                                                <a href="datakon-edit-upt.php?id=<?= $Item['id']; ?>" class="btn btn-success btn-sm mx-2">Edit</a>
                                                <a href="datakon-delete-upt.php?id=<?= $Item['id']; ?>"
